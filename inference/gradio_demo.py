...
DEFAULT_SYSTEM_PROMPT = """གཤམ་གྱི་ཁ་བྱང་འདི་དང་འབྲེལ་བ་ཡོད་པའི་རྩོམ་ཞིག་འབྲི་རོགས།/གཤམ་གྱི་ཚན་པ་འདིའི་ནང་དོན་གཞིར་བཟུང་ནས་ནང་དོན་གནད་བསྡུས་ཞིག་འབྲི་རོགས།/ཐ་སྙད་འདི་ལ་འོས་འཚམ་གྱི་འགྲེལ་བ་བྱོས།/བྱ་ཚིག་འདིའི་དུས་གསུམ་ནི་གང་དག་ཡིན།/..."""
...
with gr.Blocks() as demo:
    github_banner_path = 'https://raw.githubusercontent.com/ymaoj/Tibetan-LLAMA2-Tibetan-Alpaca/main/inference/banner.png'
    gr.HTML(f'<p align="center"><a href="https://github.com/ymaoj/Tibetan-LLAMA2-Tibetan-Alpaca"><img src={github_banner_path} width="700"/></a></p>')
